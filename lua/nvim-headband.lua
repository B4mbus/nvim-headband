...
function Headband.setup(user_config)
  vim.defer_fn(
    function()
      vim.notify(
        'The development of the nvim-headband plugin has been discontinued and the plugin will not be maintained, it will be deleted from GitHub in 7 days from now, that is, on 13 Dec 2022.',
